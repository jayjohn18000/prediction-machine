...
const PMCI_TABLES = [
  ...
  // Phase 0 Stream A scanner + MM v1 extensions (scanner-plan-v1 §8, mm-runtime-redesign-v2 §7).
  'source_chains',
  'measured_variables',
  'hypotheses',
...
const REQUIRED_COLUMNS = {
  ...
  mm_market_config: [
    ...
    'vpin_threshold',
    'game_state_pull_enabled',
    'max_drawdown_pct_global',
    'cooldown_after_consecutive_same_side',
    'gm_posterior_enabled',
  ],
